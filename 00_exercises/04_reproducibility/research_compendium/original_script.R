...
# setwd("00_exercises/04_reproducibility/research_compendium/raw_data")
# ====================================================================
...
#ggsave("../Figure_STRATOS.png", plot = FIGURE, width = 8, height = 5, dpi = 300)
#savePlot("Figure_STRATOS.png", type="png")
# ====================================================================
# END OF R CODE
# ===================================================================